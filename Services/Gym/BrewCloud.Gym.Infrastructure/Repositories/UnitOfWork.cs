...
namespace BrewCloud.Gym.Infrastructure.Repositories
{
    public class UnitOfWork : IUnitOfWork
    {
        protected GymDbContext _dbContext;
        ...
        public async Task MigrateDatabase(string connectionString)
        {
            ...
            using (var db = new GymDbContext(builder.Options, null, null))
            {
        ...
        public async Task MigrateDatabase(string connectionString, string targetMigrationName, string historyTable)
        {
            var builder = new DbContextOptionsBuilder<GymDbContext>();
            builder.UseSqlServer(connectionString);
            using (var db = new GymDbContext(builder.Options, null, null, historyTable))
            {
