...
namespace VetSystems.Vet.Application.Features.Definition.ProductCategory.Commands
{
    ...
    public class DeleteProductCategoriesCommanddHandler : IRequestHandler<DeleteProductCategoriesCommand, Response<bool>>
    {
        ...
        public DeleteProductCategoriesCommanddHandler(IUnitOfWork uow, IIdentityRepository identity, IMapper mapper, ILogger<CreateCustomerHandler> logger, IRepository<Domain.Entities.ProductCategories> productcategoryRepository, IIdentityRepository identityRepository)
        {
